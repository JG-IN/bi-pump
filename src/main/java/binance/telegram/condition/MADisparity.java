package binance.telegram.condition;

import java.util.ArrayDeque;
import java.util.Arrays;
import java.util.Deque;

import binance.telegram.ChartCondition;
...
//		System.out.println("curMv 는 "+this.curMV+"   이격도 결과는 "+this.curMV * this.disparity);
//		System.out.println("curval 는 "+curVal);
...
//		System.out.println("========  "+data.s+"  비교 진행  ==========");
